...
ActiveRecord::Schema.define(version: 20160412022529) do
  ...
  create_table "ch_2po_4pgr", force: :cascade do |t|
    ...
    t.float    "daytime_safety_level"
    t.float    "dark_safety_level"
    t.float    "daytime_cost"
    t.float    "dark_cost"
  end

  add_index "ch_2po_4pgr", ["geom_way"], name: "ch_2po_4pgr_geom_way_gix", using: :gist
  add_index "ch_2po_4pgr", ["source"], name: "idx_ch_2po_4pgr_source", using: :btree
  add_index "ch_2po_4pgr", ["target"], name: "idx_ch_2po_4pgr_target", using: :btree
  ...
  create_table "cities", id: :bigserial, force: :cascade do |t|
    ...
    t.geometry  "geom_area",             limit: {:srid=>4326, :type=>"geometry"}
  end
  ...
  add_index "cities", ["geom_area"], name: "cities_geom_area_gix", using: :gist
  ...
  create_table "crime_grids", force: :cascade do |t|
    ...
    t.integer  "row"
    t.integer  "col"
    t.geometry "area",                 limit: {:srid=>4326, :type=>"polygon"}
  ...
  create_table "grid_start_rows", id: false, force: :cascade do |t|
    t.integer   "id",                                                                default: "nextval('grid_start_rows_id_seq'::regclass)", null: false
    t.integer   "row",                                                                                                                       null: false
    t.geography "location", limit: {:srid=>4326, :type=>"point", :geographic=>true},                                                         null: false
  end

  add_index "grid_start_rows", ["location"], name: "grid_start_rows_location_gix", using: :gist
  ...
  create_table "po_2po_4pgr", force: :cascade do |t|
    t.integer  "osm_id",                    limit: 8
    t.string   "osm_name"
    t.string   "osm_meta"
    t.integer  "osm_source_id",             limit: 8
    ...
    t.float    "x2"
    t.float    "y2"
    t.geometry "geom_way",                  limit: {:srid=>4326, :type=>"multi_line_string"}
    t.float    "daytime_safety_level"
    t.float    "dark_safety_level"
    t.float    "daytime_safety_level_norm"
    t.float    "dark_safety_level_norm"
  end

  add_index "po_2po_4pgr", ["source"], name: "idx_po_2po_4pgr_source", using: :btree
  add_index "po_2po_4pgr", ["target"], name: "idx_po_2po_4pgr_target", using: :btree

  create_table "po_2po_vertex", force: :cascade do |t|
    t.integer  "clazz"
    t.integer  "osm_id",       limit: 8
    t.string   "osm_name"
    t.integer  "ref_count"
  ...
  add_index "po_2po_vertex", ["osm_id"], name: "idx_po_2po_vertex_osm_id", using: :btree
