    ...
    def normalize_deg(deg)
      (deg + 360.0) % 360.0
		...
		def distance lat1, lng1, lat2, lng2
			return 0.0 if lat1 == lat2 and lng1 == lng2
      ...
      normalize_deg(to_deg(Math.atan2(dLong, dPhi)))
		...
		def to_row matrix_length , lat1, lng1, lat2, lng2, grid_distance
			...
			row_index = (distance(lat1,lng1,lat2,lng2))/grid_distance.to_f
			row_index.to_i
		end
		...
		def to_row_col city, lat, lng
			[
				to_row(city.total_rows, city.north_east.y, lng, lat, lng, city.grid_size),
